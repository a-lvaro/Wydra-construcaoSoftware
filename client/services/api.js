function getMovies(name) {
    return fetch(`https://api.themoviedb.org/3/search/movie?api_key=158133b16a544083e8506dccf5af2bd4&query=${name}&language=pt-BR&page=1&include_adult=true`).then((res) => res.json());
}
