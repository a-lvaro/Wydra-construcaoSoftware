function getMovies(name) {
    return fetch("https://api.themoviedb.org/3/search/movie?api_key=158133b16a544083e8506dccf5af2bd4&language=pt-BR&query=Shrek&page=5&include_adult=true").then((res) => res.json());
}
